# Generated by Django 4.1 on 2022-08-27 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.OneToOneField(blank=True, limit_choices_to={'groups': 1}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usuario_p_salud', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='paciente',
            name='usuario',
            field=models.OneToOneField(blank=True, limit_choices_to={'groups': 2}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='paciente_usuario', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono', models.CharField(max_length=13)),
                ('genero', models.CharField(choices=[('MASCULINO', 'M'), ('FEMENINO', 'F'), ('No Binario', 'NB')], max_length=10)),
                ('usuario', models.OneToOneField(blank=True, limit_choices_to={'groups': 3}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usuario_auxiliar', to=settings.AUTH_USER_MODEL)),
            ],
            options={
